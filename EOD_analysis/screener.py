...
def EOD_buy(request):
    ...
    for i in Nifty50:
        ...
        data=get_history(symbol=i,start=from_date,end=to_date)
        data.reset_index(inplace=True)
        ...
        if(Bollinger_Band_RSI(rows-1)):
            stock=stock.append({"Symbol":i,"Strategy":"Bollinger_Band_RSI","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        
            
        if(MACD_signal(rows-1)):
            stock=stock.append({"Symbol":i,"Strategy":"MACD","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(Bollinger_Band_signal(rows-1)):
            stock=stock.append({"Symbol":i,"Strategy":"Bollinger_band","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(rsi_oversold(rows-1)):
            stock=stock.append({"Symbol":i,"Strategy":"rsi_oversold","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(triple_supertrend(rows-1)):
            stock=stock.append({"Symbol":i,"Strategy":"triple_supertrend_change-14-10-7","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(supertrend_change(rows-1)==14):
            stock=stock.append({"Symbol":i,"Strategy":"supertrend14","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(supertrend_change(rows-1)==10):
            stock=stock.append({"Symbol":i,"Strategy":"supertrend10","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        
        if(is_peircing(rows-1) ):
            stock=stock.append({"Symbol":i,"Strategy":"peircing","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(is_bullish_engulfing(rows-1) ):
            stock=stock.append({"Symbol":i,"Strategy":"bullish_engulfing","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(is_bullish_harami(rows-1)):
            stock=stock.append({"Symbol":i,"Strategy":"bullish_harami","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(is_bullish_morubozu(rows-1)):
            stock=stock.append({"Symbol":i,"Strategy":"bullish_morubozu","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(is_hammer(rows-1)):
            stock=stock.append({"Symbol":i,"Strategy":"hammer","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(is_weak_hammer(rows-1)):
            stock=stock.append({"Symbol":i,"Strategy":"weak_hammer","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(is_strong_hammer(rows-1)):
            stock=stock.append({"Symbol":i,"Strategy":"strong_hammer","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)    
        if(is_inverted_hammer(rows-1)):
            stock=stock.append({"Symbol":i,"Strategy":"inverted_hammer","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(is_strong_inverted_hammer(rows-1)):
            stock=stock.append({"Symbol":i,"Strategy":"strong_inverted_hammer","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(is_weak_inverted_hammer(rows-1)):
            stock=stock.append({"Symbol":i,"Strategy":"weak_inverted_hammer","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(is_morning_doji_star(rows-1)):
            stock=stock.append({"Symbol":i,"Strategy":"morning_doji_star","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(is_morning_star(rows-1)):
            stock=stock.append({"Symbol":i,"Strategy":"morning_star","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(doji(rows-1)==1 ):
            stock=stock.append({"Symbol":i,"Strategy":"dragonfly_doji","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(doji(rows-1)==2 ):
            stock=stock.append({"Symbol":i,"Strategy":"graveyard_doji","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(doji(rows-1)==3 ):
            stock=stock.append({"Symbol":i,"Strategy":"doji","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(doji(rows-1)==7 ):
            stock=stock.append({"Symbol":i,"Strategy":"price_doji","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(doji(rows-1)==8 ):
            stock=stock.append({"Symbol":i,"Strategy":"perfectdoji_","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(doji(rows-1)==9 ):
            stock=stock.append({"Symbol":i,"Strategy":"perfect_dragonfly_doji","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(doji(rows-1)==10 ):
            stock=stock.append({"Symbol":i,"Strategy":"perfect_graveyard_doji","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(doji(rows-1)==11 ):
            stock=stock.append({"Symbol":i,"Strategy":"perfect_common_doji","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)


    return(stock)

    json_records = stock.to_json(orient ='records') 
    data_output = json.loads(json_records) 
    context = {'buy_stocks': data_output} 
    return render(request,"EOD_analysis/EOD_strategies.html",context)

def sell_EOD(request):
    ...
    for i in Nifty50:
        ...
        if(MACD_signal(rows-1)):
            stock=stock.append({"Symbol":i,"Strategy":"MACD","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(Bollinger_Band_signal(rows-1)):
            stock=stock.append({"Symbol":i,"Strategy":"Bollinger_band","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target3 },ignore_index=True)     
        if(rsi_overbought(rows-1)):
            stock=stock.append({"Symbol":i,"Strategy":"rsi_overbought","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target3 },ignore_index=True)
        if(triple_supertrend(rows-1)):
            stock=stock.append({"Symbol":i,"Strategy":"triple_supertrend_change-14-10-7","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(supertrend_change(rows-1)==14):
            stock=stock.append({"Symbol":i,"Strategy":"supertrend14","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        ...
        if(is_dark_cloud_cover(rows-1) ):
            stock=stock.append({"Symbol":i,"Strategy":"darkis_dark_cloud_cover","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(is_bearish_engulfing(rows-1) ):
            stock=stock.append({"Symbol":i,"Strategy":"bearishis_bearish_engulfing","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(is_bearish_harami(rows-1)):
            stock=stock.append({"Symbol":i,"Strategy":"beariis_bearish_harami","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(is_bearish_morubozu(rows-1)):
            stock=stock.append({"Symbol":i,"Strategy":"bearisis_bearish_morubozu","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(is_hangingman(rows-1)):
            stock=stock.append({"Symbol":i,"Strategy":"hammer","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(is_weak_hangingman(rows-1)):
            stock=stock.append({"Symbol":i,"Strategy":"weak_hangingman","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(is_strong_hangingman(rows-1)):
            stock=stock.append({"Symbol":i,"Strategy":"strong_hammer","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)    
        if(is_shootingstar(rows-1)):
            stock=stock.append({"Symbol":i,"Strategy":"shootingstar","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(is_strong_shootingstar(rows-1)):
            stock=stock.append({"Symbol":i,"Strategy":"strong_shootingstar","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(is_weak_shootingstar(rows-1)):
            stock=stock.append({"Symbol":i,"Strategy":"weak_shootingstar","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(is_evening_doji_star(rows-1)):
            stock=stock.append({"Symbol":i,"Strategy":"evening_doji_star","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(is_evening_star(rows-1)):
            stock=stock.append({"Symbol":i,"Strategy":"evening_star","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(doji(rows-1)==1 ):
            stock=stock.append({"Symbol":i,"Strategy":"dragonfly_doji","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
        if(doji(rows-1)==2 ):
            stock=stock.append({"Symbol":i,"Strategy":"graveyard_doji","Entry":entry,"StopLoss":stop_loss,"Target1":target1,"Target2":target2,"Target3":target3},ignore_index=True)
